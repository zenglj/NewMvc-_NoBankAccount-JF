...
{
    //T_ImportList
    public partial class T_ImportListBLL
    {

        private readonly SelfhelpOrderMgr.DAL.T_ImportListDAL dal = new SelfhelpOrderMgr.DAL.T_ImportListDAL();
        public T_ImportListBLL()
        { }
        ...
        /// 获得数据列表
        /// </summary>
        public List<SelfhelpOrderMgr.Model.T_ImportList> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SelfhelpOrderMgr.Model.T_ImportList> DataTableToList(DataTable dt)
        {
            List<SelfhelpOrderMgr.Model.T_ImportList> modelList = new List<SelfhelpOrderMgr.Model.T_ImportList>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SelfhelpOrderMgr.Model.T_ImportList model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new SelfhelpOrderMgr.Model.T_ImportList();
