...
namespace SelfhelpOrderMgr.BLL {
	 	//t_XFQueryTmp
		public partial class t_XFQueryTmpBLL
	{
   		     
		private readonly SelfhelpOrderMgr.DAL.t_XFQueryTmpDAL dal=new SelfhelpOrderMgr.DAL.t_XFQueryTmpDAL();
		public t_XFQueryTmpBLL()
		{}
		...
		/// 获得数据列表
		/// </summary>
		public List<SelfhelpOrderMgr.Model.t_XFQueryTmp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SelfhelpOrderMgr.Model.t_XFQueryTmp> DataTableToList(DataTable dt)
		{
			List<SelfhelpOrderMgr.Model.t_XFQueryTmp> modelList = new List<SelfhelpOrderMgr.Model.t_XFQueryTmp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SelfhelpOrderMgr.Model.t_XFQueryTmp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new SelfhelpOrderMgr.Model.t_XFQueryTmp();					
