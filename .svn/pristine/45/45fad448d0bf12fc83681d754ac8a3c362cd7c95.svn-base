...
namespace SelfhelpOrderMgr.BLL
{
    ...
    public partial class t_bank_PayListBLL
    {
        ...
        private readonly SelfhelpOrderMgr.DAL.t_bank_PayListDAL dal = new SelfhelpOrderMgr.DAL.t_bank_PayListDAL();
        public t_bank_PayListBLL()
        { }
        ...
        /// 获得数据列表
        /// </summary>
        public List<SelfhelpOrderMgr.Model.t_bank_PayList> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SelfhelpOrderMgr.Model.t_bank_PayList> DataTableToList(DataTable dt)
        {
            List<SelfhelpOrderMgr.Model.t_bank_PayList> modelList = new List<SelfhelpOrderMgr.Model.t_bank_PayList>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SelfhelpOrderMgr.Model.t_bank_PayList model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new SelfhelpOrderMgr.Model.t_bank_PayList();
