...
namespace SelfhelpOrderMgr.BLL {
	 	//t_XFInvoiceTmp
		public partial class t_XFInvoiceTmpBLL
	{
   		     
		private readonly SelfhelpOrderMgr.DAL.t_XFInvoiceTmpDAL dal=new SelfhelpOrderMgr.DAL.t_XFInvoiceTmpDAL();
		public t_XFInvoiceTmpBLL()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(SelfhelpOrderMgr.Model.t_XFInvoiceTmp model)
		{
						dal.Add(model);
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SelfhelpOrderMgr.Model.t_XFInvoiceTmp model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public SelfhelpOrderMgr.Model.t_XFInvoiceTmp GetModel()
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SelfhelpOrderMgr.Model.t_XFInvoiceTmp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SelfhelpOrderMgr.Model.t_XFInvoiceTmp> DataTableToList(DataTable dt)
		{
			List<SelfhelpOrderMgr.Model.t_XFInvoiceTmp> modelList = new List<SelfhelpOrderMgr.Model.t_XFInvoiceTmp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SelfhelpOrderMgr.Model.t_XFInvoiceTmp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new SelfhelpOrderMgr.Model.t_XFInvoiceTmp();					
