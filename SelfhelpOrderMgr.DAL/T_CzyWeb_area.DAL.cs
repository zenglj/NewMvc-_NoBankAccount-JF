...
{
	 	//T_CzyWeb_area
		public partial class T_CzyWeb_areaDAL
	{			
		...
		public void Add(SelfhelpOrderMgr.Model.T_CzyWeb_area model)
		{
			...
			strSql.Append("insert into T_CzyWeb_area(");			
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_CzyWeb_area set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete()
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_CzyWeb_area ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};
		...
		public SelfhelpOrderMgr.Model.T_CzyWeb_area GetModel()
		{
			...
			strSql.Append("  from T_CzyWeb_area ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};

			
			SelfhelpOrderMgr.Model.T_CzyWeb_area model=new SelfhelpOrderMgr.Model.T_CzyWeb_area();
