...
{
	 	//t_XFInvoiceTmp
		public partial class t_XFInvoiceTmpDAL
	{			
		...
		public void Add(SelfhelpOrderMgr.Model.t_XFInvoiceTmp model)
		{
			...
			strSql.Append("insert into t_XFInvoiceTmp(");			
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update t_XFInvoiceTmp set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete()
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_XFInvoiceTmp ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};
		...
		public SelfhelpOrderMgr.Model.t_XFInvoiceTmp GetModel()
		{
			...
			strSql.Append("  from t_XFInvoiceTmp ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};

			
			SelfhelpOrderMgr.Model.t_XFInvoiceTmp model=new SelfhelpOrderMgr.Model.t_XFInvoiceTmp();
