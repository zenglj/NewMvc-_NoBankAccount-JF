...
namespace SelfhelpOrderMgr.DAL
{
    ...
    public partial class t_bank_RcvListDAL
    {
        ...
        public bool Exists(int seqno)
        {
            ...
            strSql.Append("select count(1) from t_bank_RcvList");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into t_bank_RcvList(");
            strSql.Append("Remark,BankAccNo,BankRcvDate,AccNo,FCrimeCode,FName,Amount,SuccFlag,RcvDate,LoadDate,Flag");
            ...
            parameters[8].Value = model.RcvDate;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update t_bank_RcvList set ");
            ...
            parameters[9].Value = model.RcvDate;
        ...
        public bool Delete(int seqno)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from t_bank_RcvList ");
            strSql.Append(" where seqno=@seqno");
            SqlParameter[] parameters = {
					new SqlParameter("@seqno", SqlDbType.Int,4)
			};
        ...
        public SelfhelpOrderMgr.Model.t_bank_RcvList GetModel(int seqno)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select seqno, Remark, BankAccNo, BankRcvDate, AccNo, FCrimeCode, FName, Amount, SuccFlag, RcvDate, LoadDate, Flag  ");
            strSql.Append("  from t_bank_RcvList ");
            strSql.Append(" where seqno=@seqno");
            SqlParameter[] parameters = {
					new SqlParameter("@seqno", SqlDbType.Int,4)
			};
            ...
            SelfhelpOrderMgr.Model.t_bank_RcvList model = new SelfhelpOrderMgr.Model.t_bank_RcvList();
