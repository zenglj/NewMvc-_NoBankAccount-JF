...
namespace SelfhelpOrderMgr.DAL
{
    ...
    public partial class T_BONUSDTLDAL
    {
        ...
        public int Add(SelfhelpOrderMgr.Model.T_BONUSDTL model)
        {
            ...
            strSql.Append("vouno,Frealareacode,FrealAreaName,remark,ptype,udate,crtby,crtdt,applyby,acctype,BID,cardtype,AmountC,cqbt,gwjt,ldjx,tbbz,grkj,AmountA,FCRIMECODE,AmountB,CARDCODE,FAMOUNT,FLAG,fareacode,fareaName,fcriminal");
            ...
            parameters[19].Value = model.FCRIMECODE;
        ...
        public SelfhelpOrderMgr.Model.T_BONUSDTL GetModel(int seqno)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select seqno, vouno, Frealareacode, FrealAreaName, remark, ptype, udate, crtby, crtdt, applyby, acctype, BID, cardtype, AmountC, cqbt, gwjt, ldjx, tbbz, grkj, AmountA, FCRIMECODE, AmountB, CARDCODE, FAMOUNT, FLAG, fareacode, fareaName, fcriminal  ");
