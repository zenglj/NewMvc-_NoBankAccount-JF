...
{
	 	//T_Vcrd_old
		public partial class T_Vcrd_oldDAL
	{			
		...
		public void Add(SelfhelpOrderMgr.Model.T_Vcrd_old model)
		{
			...
			strSql.Append("insert into T_Vcrd_old(");			
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_Vcrd_old set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete()
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_Vcrd_old ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};
		...
		public SelfhelpOrderMgr.Model.T_Vcrd_old GetModel()
		{
			...
			strSql.Append("  from T_Vcrd_old ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};

			
			SelfhelpOrderMgr.Model.T_Vcrd_old model=new SelfhelpOrderMgr.Model.T_Vcrd_old();
