$(function () {
    ...
    $('#test').datagrid({
        ...
        columns: [[
            ...
            { field: 'FAMOUNT', title: '实发积分', width: 150, editor: 'numberbox' },
            { field: 'AmountA', title: '存款', width: 150, hidden: true },
            { field: 'AmountB', title: '劳酬', width: 150, hidden: true },
            { field: 'AmountC', title: '留存', width: 150, hidden: true },
