...
App.init = function() {
	// Prep the document
	App.video = document.querySelector('videoel');
	
	App.glasses = new Image();
	App.glasses.src = "i/glasses.png";

	App.canvas = document.querySelector("#overlay");
	...
	if (navigator.getUserMedia) {
		navigator.getUserMedia(document.querySelector('videoel'), App.successCallback, App.errorCallback);
	}
